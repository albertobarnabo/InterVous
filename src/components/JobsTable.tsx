                    ...
                    <div className="hidden md:block overflow-x-auto overflow-y-visible">
                        <table className="w-full text-sm text-left text-slate-600 table-auto border-separate border-spacing-0">
                            <thead className="text-xs font-black text-slate-800 uppercase tracking-widest bg-white/40 backdrop-blur-xl sticky top-0 z-10 border-b border-white/30 shadow-sm">
                                <tr>
                                    <th className="px-10 py-6 border-b border-white/20">Company & Role</th>
                                    <th className="px-6 py-6 border-b border-white/20 cursor-pointer hover:text-blue-600 transition-colors" onClick={() => handleSort('location')}>
                                        <div className="flex items-center gap-2">
                                            Location {renderSortSymbol('location')}
                                        </div>
                                    </th>
                                    <th className="px-6 py-6 border-b border-white/20 cursor-pointer hover:text-blue-600 transition-colors" onClick={() => handleSort('application_date')}>
                                        <div className="flex items-center gap-2 text-nowrap">
                                            Applied On {renderSortSymbol('application_date')}
                                        </div>
                                    </th>
                                    <th className="px-6 py-6 border-b border-white/20 cursor-pointer hover:text-blue-600 transition-colors" onClick={() => handleSort('status')}>
                                        <div className="flex items-center gap-2">
                                            Status {renderSortSymbol('status')}
                                        </div>
                                    </th>
                                    <th className="px-6 py-6 border-b border-white/20">Stage</th>
                                    <th className="px-10 py-6 border-b border-white/20 text-right font-black">Manage</th>
                                </tr>
                            </thead>
                                        ...
                                        <td colSpan={6} className="px-8 py-32 text-center">
                                            <div className="flex flex-col items-center gap-4">
                                                ...
                                                <div className="space-y-1">
                                                    <p className="text-slate-900 font-black text-xl tracking-tight drop-shadow-sm">Your hunt starts here.</p>
                                                    <p className="text-slate-700 font-medium max-w-xs mx-auto drop-shadow-sm">Click &quot;Add Application&quot; above to start tracking your professional journey.</p>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        >
                                            <td className="px-10 py-7 relative">
                                                ...
                                                <div className="flex flex-col">
                                                    <span className="text-lg font-black text-slate-900 group-hover:text-blue-700 transition-colors tracking-tight drop-shadow-sm">{job.company_name}</span>
