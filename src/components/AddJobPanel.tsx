                ...
                <div className="relative z-10 p-2">
                    <header className="mb-10">
                        <div className="flex items-center gap-6 mb-8">
                            ...
                            <div>
                                <h2 className="text-4xl font-black text-slate-900 tracking-tight leading-tight">Add New Job</h2>
                                <p className="text-slate-500 font-bold text-base mt-2">Paste the link of the job application to proceed</p>
                            </div>
                        </div>
                    </header>
                    ...
                    <div className="space-y-8">
                        <div className="space-y-4">
                            ...
                            <div className="relative group">
                                ...
                                />
                                <div className="absolute right-6 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-blue-600 transition-colors">
                        ...
                        <div className="flex items-center gap-4 bg-indigo-50/50 p-5 rounded-3xl border border-indigo-100/50 group hover:bg-indigo-50 transition-colors cursor-pointer" onClick={() => setApplied(!applied)}>
                            <div className={`w-8 h-8 rounded-xl border-2 flex items-center justify-center transition-all duration-300 ${applied ? 'bg-indigo-600 border-indigo-600 text-white shadow-lg shadow-indigo-500/30 scale-110' : 'bg-white border-slate-200'}`}>
