            ...
            <div className="flex min-h-full items-center justify-center p-4 md:p-6 text-center">
                ...
                <div className="relative z-10 p-2">
                    <header className="mb-10 text-center">
                        <div className="inline-flex items-center justify-center w-20 h-20 bg-slate-900 rounded-[2rem] text-white mb-6 shadow-xl shadow-slate-900/20">
                        ...
                        <h2 className="text-4xl font-black text-slate-900 tracking-tight leading-tight">AI Command Center</h2>
                        <p className="text-slate-500 font-bold text-base mt-2">Deploy your API keys to empower the extraction engine.</p>
                    </header>
                            ...
                            <div key={field} className="space-y-3 group">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        placeholder="••••••••••••••••"
                                        className="w-full bg-slate-50 border border-slate-200 rounded-3xl px-8 py-5 text-base font-black text-slate-900 focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:bg-white focus:border-blue-500 transition-all placeholder:text-slate-400 pr-16"
                                    />
                                    <div className="absolute right-8 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-blue-600 transition-colors">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6">
                        <button
                            onClick={onClose}
                            className="cursor-pointer flex-1 bg-slate-100/80 text-slate-500 px-10 py-5 rounded-3xl font-black text-xs uppercase tracking-[0.2em] hover:bg-slate-200 transition-all active:scale-95"
                        >
                            Not Now
                        </button>
                        <button
                            ...
                            disabled={loading}
                            className="cursor-pointer flex-[2] bg-slate-900 text-white px-12 py-5 rounded-3xl font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-slate-900/20 hover:shadow-2xl hover:shadow-slate-900/30 transition-all transform hover:-translate-y-1 active:scale-95"
                        >
