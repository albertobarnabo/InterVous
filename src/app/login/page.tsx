...
export default function LoginPage() {
            ...
            <div className="min-h-screen w-full flex items-center justify-center relative bg-slate-50 overflow-hidden selection:bg-blue-500/30">
                ...
                <div className="max-w-md w-full mx-4 relative overflow-hidden rounded-[2.5rem] md:rounded-[3.5rem] shadow-[0_6px_24px_rgba(0,0,0,0.2)]">
                    ...
                    <div 
                        ...
                        style={{
                            backgroundImage: `url('https://i.pinimg.com/736x/ef/15/1f/ef151f2ddab89b741e885ff3a463aa5e.jpg')`,
                        }}
                    />
    ...
    <h1 className="text-3xl md:text-4xl font-black text-slate-900 tracking-tight leading-tight italic drop-shadow-sm">INTERVOUS</h1>
    <p className="text-slate-800 mt-2 text-center font-bold text-sm md:text-base drop-shadow-sm">Continue your professional adventure.</p>
</div>

                                <form onSubmit={handleSubmit} className="space-y-5 md:space-y-6">
                                    <div className="space-y-2 md:space-y-3">
                                        <label className="text-xs font-black text-slate-700 uppercase tracking-[0.2em] ml-3 drop-shadow-sm">Access Email</label>
                                        <input
                                            type="email"
                                    ...
                                    <div className="space-y-2 md:space-y-3">
                                        <label className="text-xs font-black text-slate-700 uppercase tracking-[0.2em] ml-3 drop-shadow-sm">Password</label>
                                        <input
                                            type="password"
                                            placeholder="••••••••••••"
                                            value={password}
